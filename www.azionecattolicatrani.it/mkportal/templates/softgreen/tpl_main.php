...
<table class="tabmaingreen" width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
...
<!-- begin right column -->
		...
		<div style="text-align:left;"><a href="javascript:ColumnOpen('menudx');MemoPos('MKmenudx', '0')">
<img src="$mklib->images/f2.gif" border="0" alt="" /></a></div>
		</div>
		</td>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
	      <tr>
		<td class="urlo" style="background-image: url('$mklib->images/m_sf.gif')" width="100%" valign="bottom" nowrap="nowrap">
		   <img src="$mklib->images/wmk.gif" border="0" alt="" />
		</td>		
	      </tr></table>
