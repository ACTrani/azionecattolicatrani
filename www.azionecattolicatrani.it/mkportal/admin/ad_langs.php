...
class mk_ad_langs {
	...
	function list_current() {
        ...
        $content = "
        <tr><td>
        <form action='admin.php?ind=ad_langs&op=process' name='AdminLang' method='post'>
        <table width='100%' border='0'>
            ...
            <tr>
                <td>
                    <br />
                    <input type='submit' name='run' value='{$mklib->lang['ad_langs_sel_ok']}' class='bgselect'>
                </td>
            </tr>
        </table>
        </form>
        ...
        $content = "
        <tr><td>
        <form action='admin.php?ind=ad_langs' name='AdminCopy' method='post'>
        ...
        <table width='100%' border='0'>
            ...
            <tr>
                <td><br /><input type='submit' name='run' value='{$mklib->lang['ad_langs_copy_ok']}' class='bgselect'></td>
            </tr>
        </table>
        </form>
        </td></tr>
        ...
        $sync_info
        <tr><td>
        <form action='admin.php?ind=ad_langs' name='AdminSync' method='post'>
        ...
        <table width='100%' border='0'>
            ...
            <tr>
                <td><br /><input type='submit' name='run' value='{$mklib->lang['ad_langs_sync_ok']}' class='bgselect'></td>
            </tr>
        </table>
        </form>
        </td></tr>
	...
	function process($message = "") {
        ...
        $message
        <tr><td>
        <form action='admin.php?ind=ad_langs&op=process' name='AdminFile' method='post'>
        ...
        <table width=\"100%\" border=\"0\">
            ...
            <tr>
                <td>
                    <br />
                    <input type=\"submit\" name=\"run\" value=\"{$mklib->lang['ad_langs_edit_ok']}\" class=\"bgselect\">&nbsp;&nbsp;
                    <input type='submit' name='translate' value='{$mklib->lang['ad_langs_translate']}' class='bgselect'>&nbsp;
                    <input type=\"submit\" name=\"back\" value=\"{$mklib->lang['ad_langs_back']}\" class=\"bgselect\">
                </td>
            </tr>
        </table>
        </form>
        ...
        if (is_file($this_file)) {
            ...
            if (is_array($langmk)) {
                $content = "
                     <tr><td>
                        <form action='admin.php?ind=ad_langs&op=save' name='AdminEdit' method='post'>
                        <input type='hidden' name='lang' value='{$lang}' />
                    ...
                    if ($act_editor_status == "html") {
                        ...
                        $content .= "
                            <tr>
                                ...
                                <td class=\"tdblock\" $style_row >
                                    <center><input type='submit' name='switch_".$key."' value='RAW'  class='bgselect' /></center>
                                </td>
                                <td class=\"tdblock\" $style_row>
                        ...
                        $content .= "
                            <tr>
                                ...
                                <td class=\"tdblock\" $style_row>
                                    <center><input type='submit' name='switch_".$key."' value='HTML'  class='bgselect' /></center>
                                </td>
                                <td class=\"tdblock\" $style_row>
                ...
                $content .= "
                     <tr>
                        <td>
                            ...
                            <br /><input type='submit' name='run' value='{$mklib->lang['ad_langs_file_save']}' class='bgselect' size=>
                        </td>
                    </tr>
                    ";
                $content .= "\n                     </table>\n";
        ...
        $mklib->printpage_admin("{$mklib->lang['ad_titlepage']}", $output, $editor['load']);
  	}
	...
	function process_single($message = "") {
        ...
        <tr>
            <td>
                <form action='admin.php?ind=ad_langs&op=save_single' name='AdminFile' method='post'>
                <input type='hidden' name='file' value='{$file}' />
        ...
        $content .= "
                    <tr>
                        ...
                        <td>
                            <br />
                            <input type='submit' name='run' value='{$mklib->lang['ad_langs_files_save']}' class='bgselect' size=>
                            <br /><br />
                        </td>
                    </tr>
                </table>
	...
	function process_translate($output = "", $message = "") {
        ...
        <tr>
            <td>
                <form action='admin.php?ind=ad_langs&op=save_translate' name='AdminFile' method='post'>
        ...
        if ($num == 0) {
            ...
            $content .= "
                        <tr>
                            ...
                            <td>
                                <br />
                                    <input type=\"submit\" name=\"save\" value=\"{$mklib->lang['ad_langs_edit_ok']}\" class=\"bgselect\">&nbsp;
                                    <input type=\"submit\" name=\"back\" value=\"{$mklib->lang['ad_langs_back']}\" class=\"bgselect\">
                                <br /><br />
                            </td>
                        </tr>
