...
class mk_ad_news {
	...
	function edit_event() {
   		global $mkportals, $mklib, $Skin, $DB, $MK_TEMPLATE;
		...
		$iconurl = "$mklib->mkurl/templates/$MK_TEMPLATE/images";
		switch($icona) {
			case '1':
				$image = "$iconurl/icona_news.gif";
    		break;
			case '2':
    			$image = "$iconurl/icona_help.gif";
    			break;
			case '3':
				$image = "$iconurl/icona_star.gif";
    		break;
			case '4':
				$image = "$iconurl/icona_pc.gif";
    		break;
			case '5':
				$image = "$iconurl/icona_world.gif";
    		break;
    		default:
    			$image = $icona;
    		break;
