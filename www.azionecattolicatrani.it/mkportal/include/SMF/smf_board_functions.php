...
//blocks functions
    ...
    function get_forumnav()
     {
        ...
        $content = "
                <tr><td width=\"100%\" class=\"tdblock\"><img src=\"$mklib->images/atb_cerca.gif\" align=\"left\" alt=\"\" />&nbsp;<a class=\"uno\" href=\"{$mkportals->forum_url}/index.php?action=unread\">{$mklib->lang['m_newpost']}</a></td></tr>
                <tr><td width=\"100%\" class=\"tdblock\"><img src=\"$mklib->images/atb_cerca.gif\" align=\"left\" alt=\"\" />&nbsp;<a class=\"uno\" href=\"{$mkportals->forum_url}/index.php?action=unreadreplies\">{$mklib->lang['new_replies']}</a></td></tr>
                <tr><td width=\"100%\" class=\"tdblock\"><img src=\"$mklib->images/atb_members.gif\" align=\"left\" alt=\"\" />&nbsp;<a class=\"uno\" href=\"{$mkportals->forum_url}/index.php?action=mlist\">{$mklib->lang['m_users']}</a></td></tr>
                <tr><td width=\"100%\" class=\"tdblock\"><img src=\"$mklib->images/atb_help.gif\" align=\"left\" alt=\"\" />&nbsp;<a class=\"uno\" href=\"{$mkportals->forum_url}/index.php?action=help\">{$mklib->lang['m_help']}</a></td></tr>
              ";
            return $content;
  ...
  return $out;
	...
	if ($avatar_url) {
		$avatar_img = "<img src=\"{$mkportals->forum_url}/attachments/$avatar_url\" alt=\"\" border=\"\" />";
	} else  {
	...
	$out .= "
                    ...
                    <br /><div align=\"right\" style='font-style: italic; font-weight: normal;'><a href=\"$mkportals->forum_url/index.php?topic=$tid\">$numreplies</a>&nbsp;</div>
		    </td>
                      </tr>
                      <tr>
                    <td colspan=\"2\"><br />
