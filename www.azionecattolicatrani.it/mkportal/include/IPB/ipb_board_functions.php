	...
	function get_poll_active($tid)
 	{
        ...
        if ( $poll['state'] == 'closed' ) {
            ...
            $controllo = 0;
            $poll_footer = "<tr><td><input type=\"submit\" value=\"{$mklib->lang['poll_vote']}\" class=\"bgselect\" style=\"margin-top: 10px;\" /></form>";
        }
        if ($controllo == 1) {
            $total_votes = 0;
            $output .= "            
	...
	function get_forumnav()
 	{
		...
		$out = "
				<tr><td width=\"100%\" class=\"tdblock\"><img src=\"$mklib->images/atb_npost.gif\" align=\"left\" alt=\"\" />&nbsp;<a class=\"uno\" href=\"{$mkportals->base_url}?act=Search&amp;CODE=getnew\">{$mklib->lang['m_newpost']}</a></td></tr>
				<tr><td width=\"100%\" class=\"tdblock\"><img src=\"$mklib->images/atb_members.gif\" align=\"left\" alt=\"\" />&nbsp;<a class=\"uno\" href=\"{$mkportals->base_url}?act=Members\">{$mklib->lang['m_users']}</a></td></tr>
				<tr><td width=\"100%\" class=\"tdblock\"><img src=\"$mklib->images/atb_calendario.gif\" align=\"left\" alt=\"\" />&nbsp;<a class=\"uno\" href=\"{$mkportals->base_url}?act=calendar\">{$mklib->lang['m_calendar']}</a></td></tr>
				<tr><td width=\"100%\" class=\"tdblock\"><img src=\"$mklib->images/atb_help.gif\" align=\"left\" alt=\"\" />&nbsp;<a class=\"uno\" href=\"{$mkportals->base_url}?act=Help\">{$mklib->lang['m_help']}</a></td></tr>
     	 	";

		if (stristr($_SERVER['PHP_SELF'], $mklib->forumpath)) {
        	$out .= "<tr><td width=\"100%\" class=\"tdblock\"><img src=\"$mklib->images/atb_assistant.gif\" align=\"left\" alt=\"\" />&nbsp;<a class=\"uno\" href=\"javascript:buddy_pop();\" title=\"{$mklib->lang['m_assistent']}\">{$mklib->lang['m_assistent']}</a></td></tr>";
    	}
			return $out;
		...
		$out .= "
				  <table class=\"tabnews\" cellspacing=\"2\" cellpadding=\"2\" width=\"100%\">
				    ...
				    <tr>
				      ...
				      <br /><div align=\"right\" style='font-style: italic; font-weight: normal;'><a href=\"$mkportals->forum_url/index.php?showtopic=$tid\">$numreplies</a>&nbsp;</div>
				      </td>
				    </tr>
				    <tr>
				      <td colspan=\"2\"><br />
