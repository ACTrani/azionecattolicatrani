...
// Option evento
	...
	$mklib->printpage("0", "0", "{$mklib->lang['ga_imggal']}", $blocks);
	}
...
// Link Navigation bar
		$navbar = "<a href=\"index.php?ind=gallery\">{$mklib->lang['ga_mkpgal']}</a>-><a href=\"#\">{$mklib->lang['ga_insertimg']}</a>";
// Link Navigation bar		
...
<!-- Submit FILE URL -->
	...
	function add_file() {
		...
		if ($file_name) {
			...
			//Move file from server tmp directory to gallery "tmp" directory			
		...
		$output = "
			...
			<table class=\"moduleborder\" cellspacing=\"1\" cellpadding=\"0\" width=\"98%\" align=\"center\" border=\"0\">
			  ...
			  <tr>
			    ...
			    <div align=\"center\"><a href=\"http://www.mkportal.it\" target=\"_blank\">MKPGallery</a> &copy;2004-2006 <a href=\"http://www.mkportal.it\" target=\"_blank\">mkportal.it</a></div>
			    </td>
			  </tr>
			</table>
		      </td>
