...
function template_postbox(&$message)
{
	...
	if ($context['show_bbc'])
	{
		...
		// Print a drop down list for all the colors we allow!  // Begin Print a drop down list for font face . . . . . . .
   echo '<br/>  <select onchange="surroundText(\'[font=\'+this.options[this.selectedIndex].value+\']\', \'[/font]\', document.', $context['post_form'], '.', $context['post_box_name'], '); this.selectedIndex = 0;" style="margin-bottom: 1ex;">
    ...
    echo '<script language="JavaScript" type="text/javascript">
		...
		if (!isset($context['disabled_tags']['color']))
			echo ' <select onchange="surroundText(\'[color=\' + this.options[this.selectedIndex].value.toLowerCase() + \']\', \'[/color]\', document.forms.', $context['post_form'], '.', $context['post_box_name'], '); this.selectedIndex = 0; document.forms.', $context['post_form'], '.', $context['post_box_name'], '.focus(document.forms.', $context['post_form'], '.', $context['post_box_name'], '.caretPos);" style="margin-bottom: 1ex;">
							...
							<option value="#151B8D"style="color:cornflowerblue;">Corn Flower Blue</option>
							...
							<option value="Yellow" style="color:yellow;">', $txt[264], '</option>
                          	<option value="Cornsilk"style="color:cornsilk;">Cornsilk</option>						</select>';
		echo '<br />';
