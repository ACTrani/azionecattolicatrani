...
VALUES (1, 1, 1, 1, UNIX_TIMESTAMP(), 'Welcome to SMF!', 'Simple Machines', 'info@simplemachines.org', '127.0.0.1', '', 'Welcome to Simple Machines Forum!<br /><br />We hope you enjoy using your forum.&nbsp; If you have any problems, please feel free to [url=http://www.simplemachines.org/community/index.php]ask us for assistance[/url].<br /><br />Thanks!<br />Simple Machines', 'xx');
--  --------------------------------------------------------
...
VALUES ('smfVersion', 'SMF 1.1.21'),
	...
	('attachmentUploadDir', '/var/www/html/acforum/attachments'),
...
root'),
	('autoLinkUrls', '1'),
	('banLastUpdated', '0'),
	('smileys_dir', '/var/www/html/acforum/Smileys'),
	('smileys_url', 'http://localhost:8080/acforum/Smileys'),
	('avatar_directory', '/var/www/html/acforum/avatars'),
	('avatar_url', 'http://localhost:8080/acforum/avatars'),
...
VALUES (1, 'name', 'SMF Default Theme - Core'),
	(1, 'theme_url', 'http://localhost:8080/acforum/Themes/default'),
	(1, 'images_url', 'http://localhost:8080/acforum/Themes/default/images'),
	(1, 'theme_dir', '/var/www/html/acforum/Themes/default'),
	(1, 'show_bbc', '1'),
	...
	(2, 'theme_url', 'http://localhost:8080/acforum/Themes/classic'),
	(2, 'images_url', 'http://localhost:8080/acforum/Themes/classic/images'),
	(2, 'theme_dir', '/var/www/html/acforum/Themes/classic'),
	(3, 'name', 'Babylon Theme'),
	(3, 'theme_url', 'http://localhost:8080/acforum/Themes/babylon'),
	(3, 'images_url', 'http://localhost:8080/acforum/Themes/babylon/images'),
	(3, 'theme_dir', '/var/www/html/acforum/Themes/babylon');
--  --------------------------------------------------------
