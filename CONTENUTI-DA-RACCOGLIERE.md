...
**gruppo C** si può aggiungere dopo il lancio.

Formato: va benissimo un documento Word, un foglio Google o anche solo una mail.
Non serve alcuna competenza tecnica.

---

## Gruppo A — senza questo non si pubblica
...
- [ ] Indirizzo della sede — risulta: *Palazzo Arcivescovile, Via Beltrani 9, Trani*.
      Confermare, **incluso CAP e provincia** (il portale nazionale riporta ancora
      `70059 (BA)`, ma Trani è `76125 (BT)`)
- [ ] Telefono — risulta `0883 494202`: è ancora attivo?
- [ ] Email pubblica — `info@azionecattolicatrani.it`
...
- [ ] Statuto e atto normativo diocesano
- [ ] Ultimo verbale assembleare, se pubblicabile

Per ciascuno: **il file** + titolo, una riga di descrizione, settore, anno associativo.

### B3. Comunicati e notizie
- [ ] 3-4 comunicati o notizie recenti, per non pubblicare un sito vuoto
- [ ] Chi li scriverà d'ora in poi?

---

## Gruppo C — dopo il lancio
...
## Fotografie — punto delicato, da affrontare presto

Il prototipo **non usa nessuna fotografia**, di proposito: non abbiamo immagini di cui
siano chiari i diritti. Ma un sito di associazione senza volti resta freddo, quindi
servono foto vere.

- [ ] 15-20 foto di buona qualità della vita associativa (assemblee, campi, incontri)
- [ ] Per ogni foto: chi l'ha scattata e se possiamo pubblicarla
- [ ] **Foto con minori (ACR): servono le liberatorie dei genitori.** Senza liberatoria
      la foto non si pubblica, nemmeno se è bellissima.
- [ ] Vale anche per l'archivio storico: nelle cartelle del vecchio sito ci sono foto
      di ragazzi di 15 anni fa, e non possono essere ripubblicate in blocco senza
      una verifica.

---

## Archivio del vecchio sito

Del vecchio sito sopravvivono i **file** (406 PDF, circa 580 immagini), ma non le
pagine: il database è andato perso, quindi i vecchi indirizzi delle notizie non sono
recuperabili in alcun modo.

- [ ] Qualcuno può indicare **quali documenti storici sono ancora utili** e meritano di
      finire nel nuovo archivio con titolo e anno? Il resto resta raggiungibile, ma
      sepolto.
- [ ] Ci sono 4 file molto pesanti (un video da 161 MB, uno da 53 MB, un audio da
      58 MB, un archivio da 20 MB). Proposta: caricarli sul canale YouTube
      dell'associazione e sostituirli con il link. Vanno conservati?

---

## Decisioni che spettano alla Presidenza

- [ ] **Chi pubblicherà** i contenuti sul sito, e c'è un passaggio di approvazione?
- [ ] Chi è il **secondo referente tecnico**, oltre ad Andrea, per i prossimi anni?
- [ ] Chi è il **titolare del trattamento** dei dati, per l'informativa privacy?
- [ ] Gli account Google (Drive per i backup, Analytics, YouTube) sono intestati
      all'associazione e non a una persona?
